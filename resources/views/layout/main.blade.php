...
<head>
    ...
    <title>ATANI - Home of Cars</title>
            ...
            <div class="modal-body">
                <form>
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div class="form-agreement form-inner d-flex justify-content-between flex-wrap">
                                ...
                                <a href="index2.html#" class="forgot-pass">Forget Password?</a>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-inner">
                    ...
                    <div class="terms-conditon">
                        <p>By sign up,you agree to the <a href="index2.html#">‘terms & conditons’</a></p>
                    </div>
                    <ul class="social-icon">
                        <li><a href="index2.html#"><img src="{{url('')}}/public/assets/img/home1/icon/google.svg"
                                                        alt></a></li>
                        <li><a href="index2.html#"><img src="{{url('')}}/public/assets/img/home1/icon/facebook.svg" alt></a>
                        </li>
                        <li><a href="index2.html#"><img src="{{url('')}}/public/assets/img/home1/icon/twiter.svg"
                                                        alt></a></li>
                    </ul>
                </form>
            </div>
...
<div class="modal signUp-modal sell-with-us fade" id="sellUsModal01" tabindex="-1" aria-labelledby="sellUsModal01Label"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="sellUsModal01Label">Book for Service</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"><i
                        class="bi bi-x"></i></button>
            </div>
            <div class="modal-body">
...
<div class="topbar-header">
    <div class="top-bar style-2">
        ...
        <div class="topbar-right">
            <div class="hotline-area d-xl-flex d-none">
                ...
                <div class="content">
                    <span>To More Inquiry</span>
                    <h6><a href="tel:+12345678">+12345678</a></h6>
                </div>
            </div>
        </div>
    </div>
    ...
    <header class="header-area style-2">
        <div class="header-logo d-lg-none d-flex">
            <a href="index.html">
                <img alt="image" class="img-fluid" src="{{url('')}}/public/assets/img/home2/icon/home2-logo.svg"></a>
        </div>
        ...
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <a href="index.html"><img alt="image" src="{{url('')}}/public/assets/img/home2/icon/home2-logo.svg"></a>
                </div>
            </div>
            <ul class="menu-list">
                <li class="menu">
        ...
        <div class="nav-right d-flex jsutify-content-end align-items-center">
            ...
            <div class="header-right">
                <ul>
                    ...
                    <li>
                        <button type="button" class="primary-btn1 text-white" data-bs-toggle="modal"
    ...
    <div class="container-fluid">
            ...
            <div class="contact-area">
                ...
                <div class="hotline-area">
                    ...
                    <div class="content">
                        ...
                        <h6>
                            <a href="emailto:info@atanimotors.com">info@atanimotors.com</a>
                        </h6>
                    </div>
                </div>
            </div>
        ...
        <div class="footer-btm">
            <div class="copyright-area">
                <p>Copyright 2024 <a href="index2.html#">ATANIMOTORS</p>
            </div>
            <div class="social-area">
                <h6>Follow ATANIMOTORS:</h6>
                <ul>
