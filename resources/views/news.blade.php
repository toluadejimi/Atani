            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="terms-conditon">
                        <p>By sign up,you agree to the <a href="blog-standard.html#">‘terms & conditons’</a></p>
                    </div>
                    <ul class="social-icon">
                        <li><a href="blog-standard.html#"><img src="assets/img/home1/icon/google.svg" alt></a></li>
                        <li><a href="blog-standard.html#"><img src="assets/img/home1/icon/facebook.svg" alt></a></li>
                        <li><a href="blog-standard.html#"><img src="assets/img/home1/icon/twiter.svg" alt></a></li>
                    </ul>
                </form>
            </div>
        </div>
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div class="form-agreement form-inner d-flex justify-content-between flex-wrap">
                                ...
                                <a href="blog-standard.html#" class="forgot-pass">Forget Password?</a>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-inner">
    ...
    <div class="main-menu">
        ...
        <ul class="menu-list">
            <li class="menu-item-has-children">
                <a href="blog-standard.html#" class="drop-down">Home</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
            ...
            <li class="position-inherit">
                <a href="blog-standard.html#" class="drop-down">NEW CAR</a>
            ...
            <li class="position-inherit">
                <a href="blog-standard.html#" class="drop-down">USED CAR</a>
                <i class="bi bi-plus dropdown-icon d-lg-none d-block"></i>
                <div class="mega-menu">
                    <ul class="menu-row">
                        <li class="menu-single-item">
            ...
            <li class="menu-item-has-children active">
                <a href="blog-standard.html#" class="drop-down">Pages</a><i class="bi bi-plus dropdown-icon"></i>
                <ul class="sub-menu">
                    <li><a href="about.html">About Us</a></li>
                    <li><a href="brand-category.html">Brand Category</a></li>
                    <li><a href="single-brand-category.html">Single Brand Category</a></li>
                    <li>
                        <a href="blog-standard.html#">Car Listing System</a>
        ...
        <div class="topbar-right d-lg-none d-block">
            ...
            <a class="primary-btn3" href="blog-standard.html#">
                <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="cart-menu">
                ...
                <div class="cart-footer">
                    ...
                    <div class="footer-button">
                        <ul>
                            <li><a class="primary-btn2" href="blog-standard.html#">Continue Shopping</a></li>
                            <li><a class="primary-btn2" href="blog-standard.html#">Product Checkout</a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="row g-lg-4 gy-5">
            <div class="col-lg-8">
                <div class="news-card2 mb-50">
                    ...
                    <div class="content">
                        <h4><a href="blog-details.html">The Car Enthusiast: Exploring the World of Cars and Driving.</a></h4>
                ...
                <div class="news-card2 mb-50">
                    ...
                    <div class="content">
                        <h4><a href="blog-details.html">The Best Car Brands for Performance and Reliability.</a></h4>
                        <p>"The Car Enthusiast: Exploring the World of Cars and Driving." In this captivating journey, we delve into the fascinating realm of automobiles.</p>
                        <div class="news-btm d-flex align-items-center justify-content-between">
                            <div class="author-area">
                                <div class="author-img">
                ...
                <div class="news-card2 mb-50">
                    ...
                    <div class="content">
                        <h4><a href="blog-details.html">The Environmental Impact of Cars and How to Minimize It.</a></h4>
                        <p>"The Car Enthusiast: Exploring the World of Cars and Driving." In this captivating journey, we delve into the fascinating realm of automobiles.</p>
                        <div class="news-btm d-flex align-items-center justify-content-between">
                            <div class="author-area">
                                <div class="author-img">
                ...
                <div class="pagination-and-next-prev">
                    <div class="pagination">
                        <ul>
                            <li class="active"><a href="blog-standard.html#">01</a></li>
                            <li><a href="blog-standard.html#">02</a></li>
                            <li><a href="blog-standard.html#">03</a></li>
                            <li><a href="blog-standard.html#">04</a></li>
                            <li><a href="blog-standard.html#">05</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="blog-sidebar mb-50">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="widget-cnt">
                                            <div class="wi">
                                                <a href="blog-details.html"><img src="assets/img/inner-page/blog-st-01.png" alt="image"></a>
                                            </div>
                                            <div class="wc">
                                                <a class="date" href="blog-standard.html">May 18, 2023</a>
                                                <h6><a href="blog-details.html">The Environmental Impact of Cars and How to Minimize It.</a></h6>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="swiper-slide">
                                        <div class="widget-cnt">
                                            <div class="wi">
                                                <a href="blog-details.html"><img src="assets/img/inner-page/blog-st-02.png" alt="image"></a>
                                            </div>
                                            <div class="wc">
                                                <a class="date" href="blog-standard.html">May 18, 2023</a>
                                                <h6><a href="blog-details.html">The Environmental Impact of Cars and How to Minimize It.</a></h6>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="widget-cnt">
                                            <div class="wi">
                                                <a href="blog-details.html"><img src="assets/img/inner-page/blog-st-03.png" alt="image"></a>
                                            </div>
                                            <div class="wc">
                                                <a class="date" href="blog-standard.html">May 18, 2023</a>
                                                <h6><a href="blog-details.html">The Environmental Impact of Cars and How to Minimize It.</a></h6>
                    ...
                    <div class="single-widgets widget_egns_tag">
                        ...
                        <p class="wp-block-tag-cloud">
                            ...
                            <a href="blog-standard.html#">Rental</a>
                            <a href="blog-standard.html#">Hyundai</a>
                            <a href="blog-standard.html#">Driving</a>
                            <a href="blog-standard.html#">Compare</a>
                            <a href="blog-standard.html#">Buying</a>
                            <a href="car-deatils.html">Toyota</a>
                            <a href="blog-standard.html#">Audi</a>
                            <a href="blog-standard.html#">Service</a>
                        </p>
                    </div>
                </div>
                <div class="single-widgets sidebar-banner">
                    <div class="product-content">
                        <div class="text">
                            <h4><a href="blog-standard.html#">Mercedes-Benz <span>( Model-S13)</span></a></h4>
                ...
                <div class="col d-flex justify-content-xl-end justify-content-sm-center">
                    <div class="footer-widget">
                        ...
                        <div class="app-download">
                            <ul>
                                <li>
                                    <a href="blog-standard.html#"><img src="assets/img/home1/icon/google-app.svg" alt></a>
                                </li>
                                <li>
                                    <a href="blog-standard.html#"><img src="assets/img/home1/icon/apple-app.svg" alt></a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="contact-area">
                ...
                <div class="hotline-area">
                    ...
                    <div class="content">
                        ...
                        <h6><a href="https://demo-egenslab.b-cdn.net/cdn-cgi/l/email-protection#31585f575e71565c50585d1f525e5c"><span class="__cf_email__" data-cfemail="5930373f36193e34383035773a3634">[email&#160;protected]</span></a></h6>
                    </div>
                </div>
            </div>
            <div class="footer-btm-menu">
                <ul>
                    <li><a href="blog-standard.html#">Advertise With Us</a></li>
                    <li><a href="blog-standard.html#">Our Sitemap</a></li>
                </ul>
            </div>
        </div>
        <div class="footer-btm">
            <div class="copyright-area">
                <p>Copyright 2023 <a href="blog-standard.html#">DRIVCO</a> | Design By <a href="blog-standard.html#">Egens Lab</a></p>
            </div>
