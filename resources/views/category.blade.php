        ...
        <div class="banner-wrapper">
            <div class="container-fluid">
                <ul class="breadcrumb-list">
                    <li><a href="/">Home</a></li>
                    <li>{{Str::upper($name)}}</li>
                </ul>
                <div class="banner-main-content-wrap">
                    <div class="row">
                        <div class="col-xl-6 col-lg-7 d-flex align-items-center">
                            <div class="banner-content">
                                <span class="sub-title">{{ Str::upper($name)}}</span>
                                <h1>To Choose {{ Str::upper($name)}}</h1>
...
{{--                                                    <div class="logo">--}}
{{--                                                        <img src="{{url('')}}/public/assets/img/home1/icon/trstpilot-logo.svg" alt>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="star">--}}
{{--                                                        <img src="{{url('')}}/public/assets/img/home1/icon/trustpilot-star.svg" alt>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                                <div class="content">--}}
{{--                                                    <ul>--}}
...
{{--                                                <div class="review-top">--}}
{{--                                                    <div class="logo">--}}
{{--                                                        <img src="{{url('')}}/public/assets/img/home1/icon/google-logo.svg" alt>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="star">--}}
{{--                                                        <ul>--}}
    ...
    <div class="product-search-area mb-100">
        <div class="container">
            ...
            <form action="search-car" method="POST">
                @csrf
                <div class="row row-cols-xl-5 row-cols-md-3 row-cols-sm-2 row-cols-1 g-3 justify-content-left">
                    <div class="col">
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="product-card">
                            <div class="product-img">
                                ...
                                <a href="single-brand-category.html#" class="fav">
...
{{--                            <ul>--}}
{{--                                <li class="active"><a href="single-brand-category.html#">01</a></li>--}}
{{--                                <li><a href="single-brand-category.html#">02</a></li>--}}
{{--                                <li><a href="single-brand-category.html#">03</a></li>--}}
{{--                                <li><a href="single-brand-category.html#">04</a></li>--}}
{{--                                <li><a href="single-brand-category.html#">05</a></li>--}}
{{--                            </ul>--}}
{{--                        </div>--}}
